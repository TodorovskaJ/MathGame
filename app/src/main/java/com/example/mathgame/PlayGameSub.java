...
public class PlayGameSub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_game_sub);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userLife <= 0){
                    ...
                    Intent intent = new Intent(PlayGameSub.this, Result.class);
